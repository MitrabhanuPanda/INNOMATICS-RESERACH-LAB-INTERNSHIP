...
st.markdown("You can ask me anything from :red['Leave No Context Behind'] Paper")

# Gemini-api-key
f = open("C:/Users/mitra/Desktop/INNOMATICS(MITRABHANU PANDA)/GEN AI (ADVANCE)/GOOGLE KEY\KEY.txt")
api_key = f.read()
...
connection = Chroma(persist_directory="C:/Users/mitra/Desktop/INNOMATICS(MITRABHANU PANDA)/INTERNSHIP/PROJECTS/PHASE-4/Q&A RAG_LANGCHAIN PROJECT/chroma_db_rag", embedding_function=embedding_model)
